...
public class DiveSessionRemoveResource<K> extends ServerResource {
	...
	public Representation removeDivesession(Representation entity) throws ResourceException {
		...
		try {
	        ...
	        DiveSessionInputDto dsInputDto = LogbookDtoFactory.createDiveSessionInputDtoFromPOSTRequest(form, LogbookDtoFactory.REQUEST_REMOVE);
		    ...
		    resDto.setExternalToken(dsInputDto.externalToken);
